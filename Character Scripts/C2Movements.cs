...
public class C2Movements : MonoBehaviour
{
    ...
    public C2HitBoxAnimation c2Attack;
    ...
    private void Run(){
        ...
        if(c2Attack.isAttacking == false && go == true ){     
    ...
    private void Crouch()
    {
        if (Input.GetButtonDown(this.name + "_Crouch") && isGrounded == true && go == true && c2Attack.isAttacking == false)
        {
    ...
    private void Jump(){
        ...
        if(Input.GetButtonDown(this.name + "_Jump") && isGrounded == true && go == true && c2Attack.isAttacking == false){
            jumpAudio.Play();
